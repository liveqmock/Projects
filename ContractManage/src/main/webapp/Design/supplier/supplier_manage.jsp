...
<div data-options="region:'center'" title="供应商管理" style="overflow:hidden;">
		...
		<!-- 弹出层 -->	
	<div id="addVmDiv" style="background:#fafafa;padding:20px;width:460px;height:350px;display: none;border: solid gray 1px;">
	    <form id="addVmform" method="post"  enctype="multipart/form-data" novalidate style="width: 450px;height:350px;">
